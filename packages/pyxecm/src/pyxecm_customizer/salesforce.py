...
class Salesforce:
    ...
    def __init__(
        ...
        salesforce_config["objectUrl"] = (
            salesforce_config["baseUrl"] + f"/services/data/{SALESFORCE_API_VERSION}/sobjects/"
        )
        salesforce_config["queryUrl"] = salesforce_config["baseUrl"] + f"/services/data/{SALESFORCE_API_VERSION}/query/"
        salesforce_config["compositeUrl"] = (
            salesforce_config["baseUrl"] + f"/services/data/{SALESFORCE_API_VERSION}/composite/"
        )
        salesforce_config["connectUrl"] = (
            salesforce_config["baseUrl"] + f"/services/data/{SALESFORCE_API_VERSION}/connect/"
        )
        salesforce_config["toolingUrl"] = (
            salesforce_config["baseUrl"] + f"/services/data/{SALESFORCE_API_VERSION}/tooling/"
        )
